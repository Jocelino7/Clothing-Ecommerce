...
export const Image = styled.img`
    ...
    margin:${({mSm}) => mSm};
    @media screen and(min-width:600px) {
        width:${({ widthLg }) => widthLg ? widthLg : "100%"} ;
        height:${({ heightLg }) => heightLg ? heightLg : "auto"};
        max-width: ${({ maxWidthLg }) => maxWidthLg ? maxWidthLg : ""};
        max-height: ${({ maxHeightLg }) => maxHeightLg ? maxHeightLg : ""};
        margin-top: ${({mTLg}) => mTLg};
        margin-bottom: ${({mBLg}) => mBLg};
        margin:${({mLg}) => mLg};
    }
`
...
export const FlexDiv = styled.div`
    ...
    @media screen and (min-width:800px) {
        ...
        display: flex;
        flex-direction: ${({ flexDirectionLg }) => flexDirectionLg} !important;
        gap:${({ gapLg }) => gapLg};
        justify-content: ${({ justifyContentLg }) => justifyContentLg};
        align-items: ${({alignItemsLg}) => alignItemsLg};
        flex-grow: ${({flexGrowLg}) => flexGrowLg} ;
        flex-basis: ${({flexBasisLg}) => flexBasisLg} ;
        margin-top: ${({mTLg}) => mTLg};
        margin-bottom: ${({mBLg}) => mBLg};
        margin:${({mLg}) => mLg};
        padding-bottom: ${({pBLg}) => pBLg};
        padding-top: ${({pTLg}) => pTLg};
        padding: ${({pLg}) => pLg};
        margin:${({mLg}) => mLg};
        width:${({ widthLg }) => widthLg ? widthLg : "100%"} ;
        height:${({ heightLg }) => heightLg ? heightLg : "auto"};
        max-width: ${({ maxWidthLg }) => maxWidthLg ? maxWidthLg : ""} !important;
        max-height: ${({ maxHeightLg }) => maxHeightLg ? maxHeightLg : ""};
    };

...
const Footer = () => {
    ...
    return (
        <Box mt="4rem" component="footer" sx={{ backgroundColor: primary, width: "100%" }}>
            <Grid container spacing={2} direction="columns" columns={{ sm: 16, md: 16, lg: 16 }} align="center">
                ...
                <Grid item container direction="column" sm={4} lg={4} md={4}>
                ...
                <Grid item container direction="column" sm={4} lg={4} md={4}>
                    ...
                    <Link href="" rel="noreferrer" variant="inherit" underline="none" color={secondary}>Costumers</Link>
